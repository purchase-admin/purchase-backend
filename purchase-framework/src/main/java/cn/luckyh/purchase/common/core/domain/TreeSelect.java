...
public class TreeSelect implements Serializable {
    ...
    public TreeSelect(SysProjectType sysProjectType) {
        this.id = sysProjectType.getId();
        this.label = sysProjectType.getProjectTypeName();
        this.children = sysProjectType.getChildren().stream().map(TreeSelect::new).collect(Collectors.toList());
    }
