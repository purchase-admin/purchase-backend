package cn.luckyh.purchase.framework.aspectj;

import cn.luckyh.purchase.common.annotation.Log;
import cn.luckyh.purchase.common.core.domain.model.LoginUser;
import cn.luckyh.purchase.common.enums.BusinessStatus;
import cn.luckyh.purchase.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(cn.luckyh.purchase.common.annotation.Log)")
    ...
    private String argsArrayToString(Object[] paramsArray) {
        ...
        if (paramsArray != null && paramsArray.length > 0) {
            for (int i = 0; i < paramsArray.length; i++) {
                if (Objects.nonNull(paramsArray[i])) {
